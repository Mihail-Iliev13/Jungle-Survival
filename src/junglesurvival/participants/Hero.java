...
public class Hero extends Participant {
  ...
  private void createBag(List<Item> bag) {
  ...
  private void setBribAbility(List<Jewel> bribAbility) {
    this.bribAbility = new ArrayList<>();
  }
  ...
  private void setHeroLifePoints(int heroLifePoints) {
    this.heroLifePoints = heroLifePoints;
  }
